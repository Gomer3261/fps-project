...
class HANDLER:
    ...
    def __init__(self, pcol, modules):
        # pcol: Player object (collision box)
        self.pcol = pcol

        #print self.pcol.controllers
        ...
        # The inputs module
        self.inputs = modules.systems.inputs
        self.terminal = modules.systems.terminal
        self.options = modules.systems.options
